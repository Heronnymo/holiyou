...
Empfohlener Einbau auf Mentortools-Seiten:

Header + Footer:

  <div class="hy-global-header-target"></div>
  ...
  <div class="hy-global-footer-target"></div>
  <script src="https://cdn.jsdelivr.net/gh/Heronnymo/holiyou@main/holiyou-global.js"></script>
...
Alte IDs werden weiterhin unterstützt:
...
return '<a href="' + esc(item.url) + '" class="' + className + '">' + esc(item.label) + "</a>";
}).join("");
}

function socialLinks(extraClass) {
return '<div class="hy-socials ' + (extraClass || "") + '">' + HY.socials.map(function (social) {
return '<a class="hy-social-link" href="' + esc(social.url) + '" target="_blank" rel="noopener" aria-label="' + esc(social.label) + '">' + icon(social.type) + "</a>";
}).join("") + "</div>";
}

function injectStyles() {
if (document.getElementById("hy-global-style-v2")) return;

```
var css = `
  #global-header,
  #global-footer,
  .hy-global-header-target,
  .hy-global-footer-target,
  #global-header *,
  #global-footer *,
  .hy-global-header-target *,
  .hy-global-footer-target *,
  ...
  #global-footer *::after,
  .hy-global-header-target *::before,
  .hy-global-header-target *::after,
  .hy-global-footer-target *::before,
  .hy-global-footer-target *::after {
  ...
  .hy-global-header-target {
    ...
    box-shadow: 0 6px 24px rgba(67, 62, 177, 0.05);
  ...
  .hy-global-header-target .hy-header-inner {
    max-width: 1220px;
    margin: 0 auto;
    padding: 15px 26px;
    display: flex;
  ...
  .hy-global-header-target .hy-logo-link,
  #global-footer .hy-logo-link,
  .hy-global-footer-target .hy-logo-link {
    display: inline-flex;
    align-items: center;
  ...
  .hy-global-header-target .hy-logo {
    height: 42px;
    width: auto;
    max-width: 220px;
    display: block;
  ...
  .hy-global-header-target .hy-desktop-nav {
    display: flex;
    align-items: center;
  ...
  .hy-global-header-target .hy-desktop-nav a,
  .hy-global-header-target .hy-mobile-nav a {
    color: #1f2340;
    text-decoration: none;
    font-size: 15px;
    font-weight: 500;
  ...
  .hy-global-header-target .hy-desktop-nav a:hover,
  .hy-global-header-target .hy-mobile-nav a:hover {
    color: #433EB1;
  ...
  .hy-global-header-target .hy-social-wrap {
    display: flex;
    align-items: center;
    gap: 10px;
    flex-shrink: 0;
  ...
  .hy-global-header-target .hy-follow-text,
  #global-footer .hy-follow-text,
  .hy-global-footer-target .hy-follow-text {
    font-size: 13px;
    color: #6f7490;
    font-weight: 500;
    margin-right: 2px;
  ...
  .hy-global-header-target .hy-socials,
  #global-footer .hy-socials,
  .hy-global-footer-target .hy-socials {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
    gap: 8px;
  ...
  .hy-global-header-target .hy-social-link,
  #global-footer .hy-social-link,
  .hy-global-footer-target .hy-social-link {
    width: 36px;
    height: 36px;
    min-width: 36px;
    min-height: 36px;
  ...
  .hy-global-header-target .hy-social-link:hover,
  #global-footer .hy-social-link:hover,
  .hy-global-footer-target .hy-social-link:hover {
  ...
  .hy-global-header-target .hy-social-link svg,
  #global-footer .hy-social-link svg,
  .hy-global-footer-target .hy-social-link svg {
    width: 18px;
    height: 18px;
    fill: currentColor;
    display: block;
  ...
  .hy-global-header-target .hy-burger {
    display: none;
    width: 42px;
    height: 42px;
    border-radius: 999px;
  ...
  .hy-global-header-target .hy-burger span,
  .hy-global-header-target .hy-burger span::before,
  .hy-global-header-target .hy-burger span::after {
    content: "";
    display: block;
    width: 19px;
    height: 2px;
  ...
  .hy-global-header-target .hy-mobile-panel {
    display: none;
    max-width: 1220px;
    margin: 0 auto;
    padding: 0 26px 20px;
  ...
  .hy-global-header-target .hy-mobile-card {
    background: #ffffff;
  ...
  .hy-global-header-target .hy-mobile-nav {
    display: flex;
  ...
  .hy-global-header-target .hy-mobile-social {
    margin-top: 12px;
    padding-top: 14px;
  ...
  .hy-global-header-target .hy-mobile-panel .hy-social-link {
    width: 42px;
    height: 42px;
    min-width: 42px;
    min-height: 42px;
  ...
  .hy-global-header-target .hy-mobile-panel .hy-social-link svg {
    width: 20px;
    height: 20px;
  }

  #global-header.hy-menu-open .hy-mobile-panel,
  .hy-global-header-target.hy-menu-open .hy-mobile-panel {
    display: block;
  }

  #global-header.hy-menu-open .hy-burger span,
  .hy-global-header-target.hy-menu-open .hy-burger span {
    background: transparent;
  }

  #global-header.hy-menu-open .hy-burger span::before,
  .hy-global-header-target.hy-menu-open .hy-burger span::before {
    transform: translateY(0) rotate(45deg);
  }

  #global-header.hy-menu-open .hy-burger span::after,
  .hy-global-header-target.hy-menu-open .hy-burger span::after {
  ...
  .hy-global-footer-target .hy-footer-inner {
    max-width: 1220px;
    margin: 0 auto;
  ...
  .hy-global-footer-target .hy-footer-main {
    display: grid;
  ...
  .hy-global-footer-target .hy-footer-logo {
    height: 46px;
    width: auto;
    max-width: 230px;
    display: block;
  ...
  .hy-global-footer-target .hy-footer-text {
    color: #6f7490;
    font-size: 15px;
    line-height: 1.65;
    max-width: 430px;
  ...
  .hy-global-footer-target .hy-footer-title {
    color: #433EB1;
    font-size: 14px;
  ...
  .hy-global-footer-target .hy-footer-links {
    display: flex;
    flex-direction: column;
    gap: 10px;
  }
  ...
  .hy-global-footer-target .hy-footer-links a {
    color: #1f2340;
    text-decoration: none;
    font-size: 15px;
    line-height: 1.3;
  ...
  .hy-global-footer-target .hy-footer-links a:hover {
    color: #433EB1;
    transform: translateX(3px);
  }

  #global-footer .hy-footer-bottom,
  .hy-global-footer-target .hy-footer-bottom {
    margin-top: 34px;
    padding-top: 20px;
    border-top: 1px solid rgba(121, 157, 219, 0.22);
    display: flex;
  ...
  .hy-global-footer-target .hy-footer-bottom a {
    color: #6f7490;
    text-decoration: none;
    transition: color 0.22s ease;
  }

  #global-footer .hy-footer-bottom a:hover,
  .hy-global-footer-target .hy-footer-bottom a:hover {
    color: #433EB1;
  }
...
header.innerHTML = `
  <div class="hy-header-inner">
    ...
    <button type="button" class="hy-burger" aria-label="Menü öffnen" aria-expanded="false">
      <span></span>
    </button>
  </div>
  ...
  <div class="hy-mobile-panel">
    <div class="hy-mobile-card">
      <nav class="hy-mobile-nav" aria-label="Mobile Navigation">
        ${navLinks(HY.headerNav, "hy-mobile-nav-link")}
      </nav>
...
if (burger) {
  burger.addEventListener("click", function () {
    var isOpen = header.classList.toggle("hy-menu-open");
...
footer.innerHTML = `
  <div class="hy-footer-inner">
    <div class="hy-footer-main">
      <div>
        <a class="hy-logo-link" href="/" aria-label="holiYou Home">
          <img class="hy-footer-logo" src="${esc(HY.logoUrl)}" alt="holiYou!">
        </a>
    ...
    <div class="hy-footer-bottom">
      ...
      <div class="hy-legal-links">
        ${HY.legalNav.map(function (item, index) {
          ...
          return '<a href="' + esc(item.url) + '">' + esc(item.label) + '</a>' + divider;
        }).join("")}
      </div>
    </div>
  </div>
...
headers.forEach(function (header) {
  renderHeaderTarget(header);
});

footers.forEach(function (footer) {
  renderFooterTarget(footer);
});
```
